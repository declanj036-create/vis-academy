...
- `PAYMENTS.md` - instructions and env vars
...
- Add admin UI to show payments and allow marking refunds/approvals.
- Implement email receipts or add retry logic/alerting for failed webhook processing.
